...
const PIPELINE_STAGES = [
  {
    ...
    inputValue: "Standard 1-Page PDF Resume (Consulting / SDE / Quant / PM)",
    telemetry: "FASTAPI RAG: 24 bullets parsed • Embedding dimensions: 1536 • 4 weak action verbs flagged",
  ...
  },
  {
    ...
    telemetry: "CEREBRAS ENGINE: Llama-3.3 70B • Latency: 132ms • Dynamic multi-turn cross-examination triggered",
    outputLabel: "System Output",
