      ...
      <div className="w-full max-w-5xl grid md:grid-cols-2 bg-background/50 backdrop-blur-3xl border border-black/5 dark:border-white/10 shadow-2xl rounded-3xl overflow-hidden relative z-10">
        ...
        <div className="hidden md:flex flex-col justify-between p-12 bg-gradient-to-br from-primary/10 to-primary/5 relative overflow-hidden border-r border-black/5 dark:border-white/5">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm font-medium text-foreground">Trusted by 500+ IITB Students</p>
            <p className="text-xs text-muted-foreground">For Phase 1 and Phase 2 placements</p>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 relative flex flex-col justify-center">
          ...
          <div className="max-w-sm w-full mx-auto space-y-8">
            ...
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="login" className="space-y-6 mt-0 animate-in fade-in slide-in-from-left-4 duration-500">
              ...
              <TabsContent value="signup" className="space-y-6 mt-0 animate-in fade-in slide-in-from-right-4 duration-500">
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="signup-email" className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">IITB Email</Label>
                    <Input 
                      id="signup-email" 
                      type="email" 
                      placeholder="student@iitb.ac.in" 
